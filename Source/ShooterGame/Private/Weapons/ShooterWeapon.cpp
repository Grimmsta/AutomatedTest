...
int32 AShooterWeapon::GetInitialClip() const 
{
	return WeaponConfig.InitialClips;
}

void AShooterWeapon::SetInitialClip(int32 amount)
{
	WeaponConfig.InitialClips = amount;
}
